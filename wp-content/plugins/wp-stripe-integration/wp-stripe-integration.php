...
Plugin URI: 
Description: Stripe and WP Integration.
Author: Jaocb Langley
Version: 1.0
Author URI: 
*/
...
define( 'WP_STRIPE_VERSION', '7.45.0' );
...
// Load WordPress Files Once Written
// -----------------------------------------------------

// require_once( WP_STRIPE_PATH . 'includes/file-name.php' );
...
function load_wp_stripe_js() {
	...
	wp_enqueue_script( 'stripe-js', 'https://js.stripe.com/v3/', array( 'jquery' ), WP_STRIPE_VERSION );
